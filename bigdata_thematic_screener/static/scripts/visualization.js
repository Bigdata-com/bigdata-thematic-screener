const infoContents = {
    ...
    load_example: `<b>Load Example</b>:<br>By clicking this button you will load an example output that is preloaded. By using it you can get an idea of the type of output you can expect from this workflow without waiting. The input data for the example is:<br><br><div><span class="font-bold">Theme:</span> Supply Chain Reshaping</div><div><span class="font-bold">Focus:</span> Logistics automation, nearshoring strategies, and supply chain digitalization<div><span class="font-bold">Watchlist:</span> Top 100 US</div></div><div><span class="font-bold">Start date:</span> 2024-10-08 00:00:00</div><div><span class="font-bold">End date:</span> 2025-10-08 00:00:00</div><div><span class="font-bold">Frequency:</span> Y</div><span class="font-bold">Fiscal Year:</span> 2024, 2025, 2026</div>`,
};
